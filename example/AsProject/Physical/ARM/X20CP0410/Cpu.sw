...
<SwConfiguration xmlns="http://br-automation.co.at/AS/SwConfiguration" CpuAddress="SL1">
  ...
  <Libraries>
    ...
    <LibraryObject Name="templib" Source="Libraries.Loupe.templib.lby" Memory="UserROM" Language="IEC" Debugging="true" />
    <LibraryObject Name="scalelib" Source="Libraries.Loupe.scalelib.lby" Memory="UserROM" Language="Binary" Debugging="true" />
  </Libraries>
</SwConfiguration>
